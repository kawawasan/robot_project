...
public:
    ...
    void write_rn(std::chrono::duration<double> time, std::string event, std::string packet_type, std::string direction, int ack, int seq, int payload_size, int video_queue_size);
