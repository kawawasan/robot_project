...
# import analyze_camn
# import analyze_cn
import analyze_rn_cpp
import analyze_loss_delay_cpp

# 引数確認
if len(sys.argv) != 5:
    print(f"Usage: python3 {sys.argv[0]} CamN.log CN.log RN1.log RN2.log")
    sys.exit()
